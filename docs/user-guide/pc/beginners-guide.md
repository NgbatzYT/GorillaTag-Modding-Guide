...
Download Monke Mod Manager from [**Ngbatz's GitHub**](https://github.com/ngbatzyt/MonkeModManager/releases/latest). Select the **Assets** dropdown and download the .exe file named `MonkeModManager.exe`.

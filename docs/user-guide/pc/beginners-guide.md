...
![Monke Mod Manager logo](https://github.com/NgbatzYT/GorillaTag-Modding-Guide/blob/master/docs/files/mmmlogo.png)
...
Download Monke Mod Manager from either [**Graze's GitHub**](https://github.com/The-Graze/MonkeModManager/releases/latest) or [**Ngbatz' GitHub**](https://github.com/NgbatzYT/MonkeModManager/releases/latest). Select the **Assets** dropdown and download the .exe file named `MonkeModManager.exe`.

> Note: If Windows alerts you that the file is unsafe/at risk, choose to keep/run anyway. This is a false-positive.

![Preview](https://github.com/NgbatzYT/GorillaTag-Modding-Guide/blob/master/docs/files/mmmpreview.png)
...
![Right-click Menu Preview](https://github.com/NgbatzYT/GorillaTag-Modding-Guide/blob/master/docs/files/localfilescontext.png)

2. Click the address bar at the top to select your installation folder's path. Hit `CTRL`+`C` to copy this to your clipboard.  

![Copy Folder Path Preview](https://github.com/NgbatzYT/GorillaTag-Modding-Guide/blob/master/docs/files/copyfolderpath.png)
...
![BepInEx Folder Preview](https://github.com/NgbatzYT/GorillaTag-Modding-Guide/blob/master/docs/files/bepinexfolder.png)
...
![Plugins Folder Preview](https://github.com/NgbatzYT/GorillaTag-Modding-Guide/blob/master/docs/files/pluginsfolder.png)
